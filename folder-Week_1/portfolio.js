...
function hi() {
    if (themechange % 2 === 0) {
        ...
        document.querySelector(".card1").style.backgroundColor = "#4a4949ff";
        document.querySelector(".card2").style.backgroundColor = "#4a4949ff";
        document.body.style.color = "#ffffffff";
        themechange++;
    }
    else {
        document.body.style.backgroundColor = "#ffffffff"
        document.querySelector(".card1").style.backgroundColor = "#ffffffff";
        document.querySelector(".card2").style.backgroundColor = "#ffffffff";
